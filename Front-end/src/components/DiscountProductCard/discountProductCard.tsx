    ...
    return(
        <div className={style.cardContainer}>
            ...
            <div className={style.infoContainer}>
                <p style={{color: "#3E677A", fontSize: "24px", fontWeight: "400",position: 'relative', top: '1rem'}}>PIJAMA FEMININO LONGO - ESTAMPA POÁ</p>
                <div className={style.precoOriginal}>
                    <p style={{color: "#D00D10", fontWeight: "400", fontSize: "16px"}}>R$ 78,90</p>
                    <img src={linha} alt="linha" />
                </div>
                <h1 style={{marginTop: "1rem", color: "#274553", fontSize: "40px", fontWeight: "700"}}>R$ 67,80</h1>
